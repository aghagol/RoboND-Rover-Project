...
def perception_step(Rover):
    ...
    Rover.vision_image[:,:,1] = threshed_rock_samp * 255
    ...
    xpix_rock_samp, ypix_rock_samp = rover_coords(threshed_rock_samp)
    # 6) Convert rover-centric pixel values to world coordinates
    x_pix_world_navigable, y_pix_world_navigable = pix_to_world(
        xpix=xpix_navigable,
        ypix=ypix_navigable,
        xpos=Rover.pos[0],
        ypos=Rover.pos[1],
        ...
        world_size=200,
        scale=10)
    x_pix_world_obstacles, y_pix_world_obstacles = pix_to_world(
        xpix=xpix_obstacles,
        ypix=ypix_obstacles,
        xpos=Rover.pos[0],
        ypos=Rover.pos[1],
        ...
        world_size=200,
        scale=10)
    x_pix_world_rock_samp, y_pix_world_rock_samp = pix_to_world(
        xpix=xpix_rock_samp,
        ypix=ypix_rock_samp,
        xpos=Rover.pos[0],
        ypos=Rover.pos[1],
    ...
    if (min(abs(Rover.pitch), abs(Rover.pitch - 360)) < 1) and (min(abs(Rover.roll), abs(Rover.roll - 360)) < 1):
